...
VALUES
('Superman Legacy', 120, 'ACAO', 'A14', 'S', 2015, 'superman.jpg', 'James Gunn', 'David Corenswet, Rachel Brosnahan, Nicholas Hoult', 'O universo DC imaginado do zero com uma mistura singular de ação épica, humor e emoção', 7.6),
...
(
    ...
    CONSTRAINT FIL_FK_SES FOREIGN KEY(ID_FILME) REFERENCES TBL_FILME
);

INSERT INTO TBL_SESSAO VALUES
(6, '2025-07-10 11:00:00', '11:00:00', 19.99, 'Sala 1')